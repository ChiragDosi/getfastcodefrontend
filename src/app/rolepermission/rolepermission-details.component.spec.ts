...
describe('RolepermissionDetailsComponent', () => {
  ...
  it('should run #ngOnInit()', async () => {
    ...
    const req = httpTestingController.expectOne(req => req.method === 'GET' && req.url === url + data.permissionId).flush(data);   
  ...
  it('should run #onSubmit()', async () => {
    ...
    const req2 = httpTestingController.expectOne(req => req.method === 'PUT'  && req.url === url + data.permissionId).flush(data); 
    httpTestingController.verify();
